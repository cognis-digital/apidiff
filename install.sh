#!/usr/bin/env sh
# Universal installer for apidiff. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/apidiff.git"
echo "Installing apidiff ..."
