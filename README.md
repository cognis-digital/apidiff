...
[![PyPI](https://img.shields.io/pypi/v/cognis-apidiff.svg)](https://pypi.org/project/cognis-apidiff/)
[![CI](https://github.com/cognis-digital/apidiff/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/apidiff/actions)
...
APIDIFF exists for one job — breaking-change detector for openapi / graphql across commits — and does it without a SaaS bill or heavyweight setup.
...
```bash
apidiff --version
apidiff scan .                      # scan the current project
apidiff scan . --format json
apidiff scan . --fail-on high       # non-zero exit for CI gates
apidiff mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **oasdiff**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`apidiff` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
