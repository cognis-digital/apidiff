"""APIDIFF core — Breaking-change detector for OpenAPI / GraphQL across commits."""
...
RULES = [
    ("API-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("API-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("API-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
